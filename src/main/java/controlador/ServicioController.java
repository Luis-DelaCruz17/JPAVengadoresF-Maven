...
import modelo.dao.ServicioFacade;
...
public class ServicioController implements Serializable {
    ...
    @EJB
    private modelo.dao.ServicioFacade ejbFacade;
    ...
    public Servicio getServicio(java.math.BigDecimal id) {
    ...
    public static class ServicioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Servicio) {
                ...
                return getStringKey(o.getCodserv());
            } else {
