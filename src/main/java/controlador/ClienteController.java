...
import modelo.dao.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private modelo.dao.ClienteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("ClienteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("ClienteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("ClienteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Cliente getCliente(java.math.BigDecimal id) {
    ...
    public static class ClienteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cliente) {
                ...
                return getStringKey(o.getCodclie());
            } else {
